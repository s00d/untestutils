...
export const defineVitestProject: MarkerUnitFramework["defineVitestProject"] = viteUnit.defineVitestProject;
export const mountMarker: MarkerUnitFramework["mountMarker"] = viteUnit.mountMarker;
export const getUnitMarkerText: MarkerUnitFramework["getUnitMarkerText"] = viteUnit.getUnitMarkerText;
