...
async function loadKit(rootDir) {
	try {
		...
		if (e.toString().includes("Cannot find module '@nuxt/kit'")) throw new Error("`untestutils/config` requires `@nuxt/kit` to be installed in your project. Try installing `nuxt` v3+ or `@nuxt/bridge` first.", { cause: e });
		throw e;
	}
}
