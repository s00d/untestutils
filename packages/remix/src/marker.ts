...
export const defineVitestProject: MarkerUnitFramework["defineVitestProject"] = remixUnit.defineVitestProject;
export const mountMarker: MarkerUnitFramework["mountMarker"] = remixUnit.mountMarker;
export const getUnitMarkerText: MarkerUnitFramework["getUnitMarkerText"] = remixUnit.getUnitMarkerText;
