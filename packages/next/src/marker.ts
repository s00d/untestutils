...
export const defineVitestProject: MarkerUnitFramework["defineVitestProject"] = nextUnit.defineVitestProject;
export const mountMarker: MarkerUnitFramework["mountMarker"] = nextUnit.mountMarker;
export const getUnitMarkerText: MarkerUnitFramework["getUnitMarkerText"] = nextUnit.getUnitMarkerText;
