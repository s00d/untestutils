...
export const defineVitestProject: MarkerUnitFramework["defineVitestProject"] = solidstartUnit.defineVitestProject;
export const mountMarker: MarkerUnitFramework["mountMarker"] = solidstartUnit.mountMarker;
export const getUnitMarkerText: MarkerUnitFramework["getUnitMarkerText"] = solidstartUnit.getUnitMarkerText;
...
export const restartSharedApp: MarkerUnitFramework["restartSharedApp"] = solidstartUnit.restartSharedApp;
