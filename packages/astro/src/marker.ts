...
export const defineVitestProject: MarkerUnitFramework["defineVitestProject"] = astroUnit.defineVitestProject;
export const mountMarker: MarkerUnitFramework["mountMarker"] = astroUnit.mountMarker;
export const getUnitMarkerText: MarkerUnitFramework["getUnitMarkerText"] = astroUnit.getUnitMarkerText;
