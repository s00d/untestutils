...
import { _ as stringify, a as split_remote_key, b as once, c as validate_depends, f as get_status, g as text_encoder, h as get_relative_path, i as parse_remote_arg, l as validate_load_response, m as base64_encode, n as TRAILING_SLASH_PARAM, o as stringify$1, p as normalize_error, r as create_remote_key, t as INVALIDATED_PARAM, y as noop } from "./chunks/shared.js";
import { a as assets, c as reset, i as app_dir, o as base, s as override } from "./chunks/internal2.js";
import { E as ENDPOINT_METHODS, O as PAGE_METHODS, T as parseString, _ as negotiate, a as get_global_name, b as deserialize_binary_form, c as handle_fatal_error, d as redirect_response, f as serialize_uses, g as is_form_content_type, h as get_set_cookies, i as format_server_error, l as has_prerendered_path, m as escape_html, n as count_non_ssi_comments, o as get_node_type, p as static_error_page, r as create_replacer, s as handle_error_and_jsonify, t as clarify_devalue_error, u as method_not_allowed } from "./chunks/utils.js";
import { t as uneval } from "./chunks/uneval.js";
import { a as validate_server_exports, c as SCHEME, d as make_trackable, f as normalize_path, i as validate_page_server_exports, l as decode_pathname, n as validate_layout_server_exports, o as find_route, p as resolve, r as validate_page_exports, s as hash, t as validate_layout_exports, u as disable_search } from "./chunks/exports.js";
...
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/promise.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/constants.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/misc.js
var s = JSON.stringify;
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/endpoint.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/array.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/pathname.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/telemetry/noop.js
/**
* @type {Span}
*/
var noop_span = {
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/telemetry/record_span.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/actions.js
...
async function handle_action_json_request(event, event_state, options, server) {
	...
	if (!actions) {
		const no_actions_error = new SvelteKitError(405, "Method Not Allowed", `POST method not allowed. No form actions exist for ${`the page at ${event.route.id}`}`);
		return action_json({
			type: "error",
...
async function handle_action_request(event, event_state, server) {
	...
	if (!actions) {
		...
		return {
			type: "error",
			error: new SvelteKitError(405, "Method Not Allowed", `POST method not allowed. No form actions exist for ${`the page at ${event.route.id}`}`)
		};
	}
	check_named_default_separate(actions);
	try {
...
function validate_action_return(data) {
	if (data instanceof Redirect) throw new Error("Cannot `return redirect(...)` — use `redirect(...)` instead");
	if (data instanceof HttpError) throw new Error("Cannot `return error(...)` — use `error(...)` or `return fail(...)` instead");
}
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/streaming.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/data_serializer.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/load_data.js
/**
...
async function load_server_data({ event, event_state, state, node, parent }) {
	...
	const url = make_trackable(event.url, () => {
		if (done && !uses.url) console.warn(`${node.server_id}: Accessing URL properties in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the URL changes`);
		if (is_tracking) uses.url = true;
	}, (param) => {
		if (done && !uses.search_params.has(param)) console.warn(`${node.server_id}: Accessing URL properties in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the URL changes`);
		...
		fn: async (current) => {
			...
			return await with_request_store({
				...
				fetch: (info, init) => {
					...
					if (done && !uses.dependencies.has(url.href)) console.warn(`${node.server_id}: Calling \`event.fetch(...)\` in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the dependency is invalidated`);
				...
				depends: (...deps) => {
					for (const dep of deps) {
						...
						if (done && !uses.dependencies.has(href)) console.warn(`${node.server_id}: Calling \`depends(...)\` in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the dependency is invalidated`);
						uses.dependencies.add(href);
					}
				},
				params: new Proxy(event.params, { get: (target, key) => {
					if (done && typeof key === "string" && !uses.params.has(key)) console.warn(`${node.server_id}: Accessing \`params.${String(key)}\` in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the param changes`);
					if (is_tracking) uses.params.add(key);
					return target[key];
				} }),
				parent: async () => {
					if (done && !uses.parent) console.warn(`${node.server_id}: Calling \`parent(...)\` in a promise handler after \`load(...)\` has returned will not cause the function to re-run when parent data changes`);
					if (is_tracking) uses.parent = true;
					return parent();
				},
				route: new Proxy(event.route, { get: (target, key) => {
					if (done && typeof key === "string" && !uses.route) console.warn(`${node.server_id}: Accessing \`route.${String(key)}\` in a promise handler after \`load(...)\` has returned will not cause the function to re-run when the route changes`);
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/serialize_data.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/crypto.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/csp.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/server_routing.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/remote.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/render.js
var updated = {
	...readable(false),
	check: () => false
};
...
async function render_response({ branch, fetched, options, manifest, state, page_config, status, error = null, event, event_state, resolve_opts, action_result, data_serializer, error_components }) {
	...
	*/
		...
		try {
			{
				...
				globalThis.fetch = (info, init) => {
					if (typeof info === "string" && !SCHEME.test(info)) throw new Error(`Cannot call \`fetch\` eagerly during server-side rendering with relative URL (${info}) — put your \`fetch\` calls inside \`onMount\` or a \`load\` function instead`);
					else if (!warned && !try_get_request_store()?.state.is_in_remote_function) {
						console.warn("Avoid calling `fetch` eagerly during server-side rendering — put your `fetch` calls inside `onMount` or a `load` function instead");
						warned = true;
					}
	...
	if (page_config.csr) {
		if (count_non_ssi_comments(transformed) < count_non_ssi_comments(html)) console.warn("\x1B[1m\x1B[31mRemoving comments in transformPageChunk can break Svelte's hydration\x1B[39m\x1B[22m");
	} else if (chunks) console.warn("\x1B[1m\x1B[31mReturning promises from server `load` functions will only work if `csr === true`\x1B[39m\x1B[22m");
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/page_nodes.js
var PageNodes = class {
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/respond_with_error.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/page/index.js
...
async function render_page(event, event_state, page, options, manifest, state, nodes, resolve_opts) {
	...
	try {
		...
		if (ssr === false && !(state.prerendering && should_prerender_data)) {
			if (action_result && !event.request.headers.has("x-sveltekit-action")) {
				if (action_result.type === "error") console.warn("The form action returned an error, but +error.svelte wasn't rendered because SSR is off. To get the error page with CSR, enhance your form with `use:enhance`. See https://svelte.dev/docs/kit/form-actions#progressive-enhancement-use-enhance");
				else if (action_result.data) console.warn("The form action returned a value, but it isn't available in `page.form`, because SSR is off. To handle the returned value in CSR, enhance your form with `use:enhance`. See https://svelte.dev/docs/kit/form-actions#progressive-enhancement-use-enhance");
			}
			return await render_response({
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/data/index.js
/**
* @param {import('@sveltejs/kit').RequestEvent} event
* @param {import('types').RequestState} event_state
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/cookie.js
...
function get_cookies(request, url) {
	...
	const cookies = {
		...
		*/
		get(name, opts) {
			...
			const cookie = parse(header, { decode: opts?.decode })[name];
			if (!cookie) {
				const paths = Array.from(cookie_paths[name] ?? []).filter((path) => {
					return path_matches(path, url.pathname) && path !== url.pathname;
				});
				if (paths.length > 0) console.warn(`'${name}' cookie does not exist for ${url.pathname}, but was previously set at ${conjoin([...paths])}. Did you mean to set its 'path' to '/' instead?`);
			}
			return cookie;
		},
		/**
	...
	*/
	function set_internal(name, value, options) {
		...
		{
			const encoder = cookie.options.encode || encodeURIComponent;
			if (text_encoder.encode(name).byteLength + text_encoder.encode(encoder(value)).byteLength > MAX_COOKIE_SIZE) throw new Error(`Cookie "${name}" is too large, and will be discarded by the browser`);
			cookie_paths[name] ??= /* @__PURE__ */ new Set();
			if (!value) cookie_paths[name].delete(path);
			else cookie_paths[name].add(path);
		}
	}
	/**
	* @param {import('types').TrailingSlash} trailing_slash
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/fetch.js
/**
* @param {{
*   event: import('@sveltejs/kit').RequestEvent;
*   options: import('types').SSROptions;
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/env_module.js
/** @type {string} */
var payload;
/** @type {string} */
var etag;
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/validate-headers.js
/** @type {Set<string>} */
...
var CONTENT_TYPE_PATTERN = /^(application|audio|example|font|haptics|image|message|model|multipart|text|video|x-[a-z]+)\/[-+.\w]+$/i;
/** @type {Record<string, (value: string) => void>} */
var HEADER_VALIDATORS = {
	"cache-control": (value) => {
		const error_suffix = `(While parsing "${value}".)`;
		const parts = value.split(",").map((part) => part.trim());
		if (parts.some((part) => !part)) throw new Error(`\`cache-control\` header contains empty directives. ${error_suffix}`);
		const invalid = parts.map((part) => part.split("=")[0].toLowerCase()).find((directive) => !VALID_CACHE_CONTROL_DIRECTIVES.has(directive));
		if (invalid) throw new Error(`Invalid cache-control directive "${invalid}". Did you mean one of: ${[...VALID_CACHE_CONTROL_DIRECTIVES].join(", ")}? ${error_suffix}`);
	},
	"content-type": (value) => {
		const type = value.split(";")[0].trim();
		const error_suffix = `(While parsing "${value}".)`;
		if (!CONTENT_TYPE_PATTERN.test(type)) throw new Error(`Invalid content-type value "${type}". ${error_suffix}`);
	}
};
/**
...
function validateHeaders(headers) {
	for (const [key, value] of Object.entries(headers)) {
		...
		try {
			...
			if (error instanceof Error) console.warn(`[SvelteKit] ${error.message}`);
		}
	}
}
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/respond.js
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/env.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/index.js
