...
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/constants.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/form-utils.js
...
function check_prototype_pollution(key) {
	if (key === "__proto__" || key === "constructor" || key === "prototype") throw new Error(`Invalid key "${key}": This key is not allowed to prevent prototype pollution.`);
}
/**
			...
			*/
			const as_func = (type, input_value) => {
				...
				if (type === "submit" || type === "hidden") {
					if (input_value === null || input_value === void 0) throw new Error(`\`${type}\` inputs must have a value`);
				...
				if (type === "checkbox" || type === "radio") {
					if (type === "radio" && !input_value) throw new Error("Radio inputs must have a value");
					if (type === "checkbox" && is_array && !input_value) throw new Error("Checkbox array inputs must have a value");
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/http.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/utils/escape.js
/**
...
//#endregion
//#region ../../../node_modules/.pnpm/@sveltejs+kit@2.70.3_@opentelemetry+api@1.9.1_@sveltejs+vite-plugin-svelte@6.2.4_svelte_2b2babbf5ece9fe3066cfe4cc64131f7/node_modules/@sveltejs/kit/src/runtime/server/utils.js
...
function clean_up_stack_trace(error) {
	...
	if (last_line_from_src_code === -1) return error.stack;
